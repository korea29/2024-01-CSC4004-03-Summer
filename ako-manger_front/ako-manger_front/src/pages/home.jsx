  ...
  return (
    <div className="home-container">
      ...
      <div className="home-chat">
        ...
        />
        <button className="home-chat-button" onClick={gotoChat}>start chat </button>
      </div>
      <div className="home-options">
        <div className="home-option">
          <button className="home-option-icon" onClick={gotoCredit}></button>
          <span className="home-option-text" onClick={gotoCredit}>ID’s 취득 학점</span>
        </div>
        <div className="home-option">
          <button className="home-option-icon" onClick={openModal}></button>
          <span className="home-option-text" onClick={openModal}>YY %학기 시간표</span>
        </div>
        <div className="home-option">
          <button className="home-option-icon" onClick ={gotoChange}></button>
          <span className="home-option-text" onClick ={gotoChange}>ID's 정보 수정</span>
        </div>
      </div>
      {/* 모달 */}
      {modalVisible && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="modal-close-button" onClick={closeModal} style={{borderRadius: '50%', backgroundColor: '#F4E7DA', border: '1.5px solid #B7A08E', width: '40px', height: '40px', cursor: 'pointer'}}>X</button>
