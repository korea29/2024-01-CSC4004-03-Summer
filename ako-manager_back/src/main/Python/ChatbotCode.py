...
chat_response = ['안녕하세요! 아코 매니저입니다~ 원하시는 질문이 있으시다면 물어봐 주세요!', '제 이름은 아코 매니저입니다!', '안녕하세요~ 저는 동국대학교 학생들을 돕기 위해 이 세상에 태어난 아코 매니저입니다!', '수강해야 하는 과목들에 대한 정보를 불러왔어요', '다니시는 전공의 이수체계도를 가지고 왔어요', '다니시는 전공의 이수체계도를 가지고 왔어요', '쉽게 보실 수 있도록 원그래프 형식으로 들고 와 봤어요', '수강해야 하는 과목들을 기준으로 추천 시간표를 짜 봤어요', '해결되었다니 정말 다행이네요! 언제든 도움이 필요하시다면 아코 매니저를 불러 주세요!', '해당 과목을 듣기 위해서 추가로 수강해야 하는 과목들을 가지고 왔어요']
